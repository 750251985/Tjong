...
parser.add_argument('-lp', '--load_path', type=str, default='./models/dl_CNN_3heads_1681092083.2337782.pt', help='from where to load model')
...
# nohup python -u DL_CNN_3heads_agent.py > log_CNN_3heads_04101206.log 2>&1 &
