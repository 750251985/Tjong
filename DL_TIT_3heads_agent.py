...
parser.add_argument('-lp', '--load_path', type=str, default='./models/dl_TIT_3heads_blocks3_fc3_1681075761.7407126.pt', help='from where to load model')
...
args.model_name = 'dl_TIT_3heads_blocks3_fc3'
args.cuda = 'cuda:1'
