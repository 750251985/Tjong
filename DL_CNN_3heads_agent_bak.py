...
parser.add_argument('-lp', '--load_path', type=str, default='./models/rl_pg_new', help='from where to load model')
...
# nohup python -u DL_CNN_3heads_agent.py > log_DL_CNN_3heads_04081511.log 2>&1 &
