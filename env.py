...
import argparse
import time
from bot import agent as tit_agent
...
parser.add_argument('-o', '--old_path', type=str, default='/home/lb/pyproject/Mahjong-RL-botzone-master/models/super_model_2', help='path to stable model')
parser.add_argument('-n', '--new_path', type=str, default='/home/lb/pyproject/Mahjong-RL-botzone-master/dl_TIT_3heads_blocks3.pt', help='path to trained model')
...
class MahjongEnv:
    def __init__(self):
        ...
        if args.old_path == args.new_path:
            ...
            self.bots = [tit_agent(model_path), tit_agent(model_path), tit_agent(model_path), tit_agent(model_path)]
            # for i in range(4):
            #     if i != 0:
            ...
            for i in range(4):
                ...
                if i < 3 :
                    ...
                    self.bots.append(tit_agent(args.new_path))
        self.reset(True)
